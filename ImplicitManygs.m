...
%         con(I+1,n) = 2*con(I,n)-con(I-1,n);
    ...
    elseif q == 3
        ...
        figure(1)
        plot(wealth,thetaerror(2:end,1),':k')
        h1=legend({'\gamma = 0.4  ','\gamma = 0.55  ','\gamma = 0.7  ','\gamma = 0.85  '},'location','northwest');
    ...
    elseif q == 3
        ...
        figure(2)
        plot(wealth,conerror(2:end,1),':k')
        h2=legend({'\gamma = 0.4  ','\gamma = 0.55  ','\gamma = 0.7  ','\gamma = 0.85  '},'location','northwest');
        set(gca, 'YGrid', 'on', 'XGrid', 'off');
        set(h2,'FontSize',14)
    end
